...
float myAltitude (float total_time, float WB)
    {
...
float myVelocity (float total_time, float WB)
    {
...
int main()
{
    ...
    cin >> t_final;
    if (t_final - t_init <5 || t_final - t_init >24)
        {
        cout << endl;
